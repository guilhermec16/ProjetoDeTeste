    ...
    <tr>
      ...
      <td>
        <div class="grupo-botoes">
          <button class="btn neutro btn-editar-aluno" onclick="editarAluno(${aluno.id})">Editar</button>
...
btnCancelarNota.addEventListener('click', limparFormularioNota);

filtroSerie.addEventListener('change', carregarDados);
